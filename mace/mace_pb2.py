...
_OPERATORDEF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operator_latency', full_name='mace.OperatorDef.operator_latency', index=16,
...
_OPERATORDEF.fields_by_name['operator_latency'].message_type = _OPRATORLATENCY
